...
public class UserServiceImpl implements UserService{
	...
	@Override
	public User sa(String userNo, String userId, String userPw, String userName, String enrollDate) {
		
		Connection conn = getConnection();
		
		User saUser = dao.sa(conn,userNo,userId, userPw,  userName,enrollDate);
		return saUser;
